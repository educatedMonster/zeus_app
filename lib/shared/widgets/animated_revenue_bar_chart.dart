...
class AnimatedRevenueBarChart extends StatefulWidget {
  ...
  final List<RevenueDataModel> list;

  const AnimatedRevenueBarChart({
    super.key,
    required this.list,
  ...
  @override
  State<AnimatedRevenueBarChart> createState() =>
      _AnimatedRevenueBarChartState();
}

class _AnimatedRevenueBarChartState extends State<AnimatedRevenueBarChart>
    with TickerProviderStateMixin {
  List<RevenueDataModel> _list = [];
  ...
  void initState() {
    ...
    _rawBarGroups = _list
        .map((e) => make3GroupData(e.order, e.a, e.b, e.c))
        .toList();
