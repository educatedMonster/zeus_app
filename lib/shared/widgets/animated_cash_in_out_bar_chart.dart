...
class AnimatedCashInOutBarChart extends StatefulWidget {
  ...
  final List<CashInOutBarDataModel> list;

  const AnimatedCashInOutBarChart({
    super.key,
    required this.list,
  ...
  @override
  State<AnimatedCashInOutBarChart> createState() =>
      _AnimatedCashInOutBarChartState();
}

class _AnimatedCashInOutBarChartState extends State<AnimatedCashInOutBarChart>
    with TickerProviderStateMixin {
  List<CashInOutBarDataModel> _list = [];
